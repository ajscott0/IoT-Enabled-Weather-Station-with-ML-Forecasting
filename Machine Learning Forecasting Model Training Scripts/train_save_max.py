...
# Target variable: next day's maximum temperature
...
# Define predictors (every column except target and day_of_year)
...
joblib.dump(best_rf, "max_temp_model_saved.pkl")
